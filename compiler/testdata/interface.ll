...
entry:
  call void @runtime.trackPointer(ptr nonnull @"reflect/types.type:basic:int", ptr undef) #6
...
entry:
  call void @runtime.trackPointer(ptr nonnull @"reflect/types.type:pointer:basic:int", ptr undef) #6
  call void @runtime.trackPointer(ptr null, ptr undef) #6
...
entry:
  call void @runtime.trackPointer(ptr nonnull @"reflect/types.type:pointer:named:error", ptr undef) #6
  call void @runtime.trackPointer(ptr null, ptr undef) #6
...
entry:
  call void @runtime.trackPointer(ptr nonnull @"reflect/types.type:pointer:interface:{String:func:{}{basic:string}}", ptr undef) #6
  call void @runtime.trackPointer(ptr null, ptr undef) #6
