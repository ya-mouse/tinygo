...
func TestBinarySize(t *testing.T) {
	...
	tests := []sizeTest{
		// microcontrollers
		{"hifive1b", "examples/echo", 4943, 229, 0, 2252},
		{"microbit", "examples/serial", 3012, 164, 8, 2248},
		{"wioterminal", "examples/pininterrupt", 7164, 744, 116, 6424},

		// wasm
		{"wasm", "examples/serial", 32303, 0, 792, 130280},
		{"wasi", "examples/serial", 14874, 0, 316, 130756},
	}
