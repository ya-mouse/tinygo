...
var (
	...
	UART0  = &_UART0
	UART1  = &_UART1
	_UART0 = UART{UART_Type: nrf.UART0, Buffer: NewRingBuffer(), IrqId: nrf.IRQ_UART0}
	_UART1 = UARTE{UARTE_Type: nrf.UARTE1, Buffer: NewRingBuffer(), IrqId: nrf.IRQ_UARTE1}
)
...
func (uart *UART) Configure(config UARTConfig) {
	...
	case nrf.IRQ_UARTE1:
	    intr = interrupt.New(nrf.IRQ_UARTE1, _UART1.handleInterrupt)
	}
